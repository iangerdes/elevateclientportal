 ...
 * @version 13.3.0 (Permission Fix)
 * @comment Re-scoped the 'Managed By' field to only be editable by users with the 'promote_users' capability, restoring the intended permission structure.
 */

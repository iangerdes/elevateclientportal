<?php
// File: frontend/views/components/file-manager-all-users.php
/**
...
// @var ECP_File_Manager_Component $file_manager_component The instance of the component class.
?>
<div class="ecp-dashboard-view ecp-file-manager" id="ecp-file-manager-view-0">
    ...
    <div class="columns-2">
        <div class="ecp-file-manager-list-col">
            ...
            <?php
            $user_id = 0;
            include $file_manager_component->plugin_path . 'frontend/views/components/bulk-actions.php';
            ?>
            ...
            <div class="table-container"><table class="wp-list-table widefat fixed striped">
                ...
                <tbody class="file-list-body"><?php echo $file_manager_component->render_all_users_table_rows('all', $all_clients); ?></tbody>
            </table></div>
        </div>
        <div class="ecp-file-manager-forms-col">
            ...
            <?php
            $user_id = 0;
            include $file_manager_component->plugin_path . 'frontend/views/components/manage-folders.php';
            ?>
    ...
    <?php
    include $file_manager_component->plugin_path . 'frontend/views/components/files-modal.php';
    ?>

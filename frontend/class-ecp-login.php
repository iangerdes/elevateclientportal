 ...
 * @version 112.0.0 (Native Login Form)
 * @comment Re-engineered to use the core wp_login_form() function. This provides maximum compatibility and resolves persistent "Security check failed" errors caused by environmental conflicts.
 */
class ECP_Login {
    ...
    public function render_shortcode() {
        ECP_Asset_Manager::get_login_assets_loader()->enqueue_scripts();
